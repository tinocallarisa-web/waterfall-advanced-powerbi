...
export declare class NamedEntity {
    displayName?: string;
...
export declare class ItemDropdown extends SimpleSlice<powerbi.IEnumMember | ILocalizedItemMember> {
    ...
    setValue?(value: powerbi.EnumMemberValue, localizationManager?: powerbi.extensibility.ILocalizationManager): void;
}
 ...
 * 4 = show percent
 */
export declare class ItemFlagsSelection extends SimpleSlice<number> {
    items: powerbi.IEnumMember[] | ILocalizedItemMember[];
    type?: visuals.FormattingComponent;
 ...
 * 4 = show percent
 */
export declare class AutoFlagsSelection extends SimpleSlice<number> {
    type?: visuals.FormattingComponent;
}
